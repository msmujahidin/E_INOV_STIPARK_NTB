...
<html lang="en">
    <head>
        ...
        <title>Daftar Ulang Pra Inkubasi Binis</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">INKUBASI BISNIS</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Daftar Ulang Pra Inkubasi Bisnis</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">STIPARK NTB 2020</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Pendaftaran Ulang Akan dibuka setelah pengumuman dinyatakannya peserta lolos</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">gunakna email yang valid untuk pendaftaran Ulang</p></div>
                </div>
        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Alamat STIPark NTB</h4>
                        <p class="lead mb-0">
                        Banyumulek, Kediri, Kabupaten Lombok Barat, Nusa Tenggara Bar. 83362
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright@MUH.SYA'RONI MUJAHIDIN</small></div>
        </div>
