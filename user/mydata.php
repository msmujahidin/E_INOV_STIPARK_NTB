...
<head>
    ...
    <title>E-INOV: Pendaftaran</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di sistem informasi Penerimaan Peserta Pran Inkubasi STIPark NTB
                                         <br>Sistem ini disusun oleh Muhamamd Sya'roni Mujahidin
                                         <br><br>
                                         Panduan Pendaftaran:
                                         ...
                                         <br>
                                         <br>*Note: Pihak STIPark baru akan menerima data Anda setelah Anda klik 'Confirm'
                                    </div>
                                </div>
                            </div>
                        </div>
      ...
      <form method="post">
        ...
        <footer>
            <div class="footer-area">
                <p>E-INOV by Muhammad Sya'roni Mujahidin</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
