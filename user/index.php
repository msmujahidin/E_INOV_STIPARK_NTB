...
<head>
    ...
    <title>E-INOV: User Dashboard</title>
    ...
    <div class="page-container">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di sistem informasi STIPark NTB.
                                         <br>Sistem ini disusun oleh Muhammad Sya'roni Mujahidin
                                         <br><br>
                                         Panduan Pendaftaran:
        ...
        <footer>
            <div class="footer-area">
                <p>PPDB Online by Muhammad Sya'roni Mujahidin</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
